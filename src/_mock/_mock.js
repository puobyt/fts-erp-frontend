...
export const _times = (index) =>
  ...
  export const NameOfTheFirm = (index) =>
    [
      'Tata Steel',
      'ABC Industries',
    ][index];
...
export const address = (index) =>
  [
    'Mumbai Maharashtra',
    '34 Textile Hub , Cotton road,surat, Gujarat',
...
export const contact = (index) =>
  ...
  export const contactPersonName = (index) =>
    [
      'Johns - Aufderhar',
      'Schmidt LLC',
    ][index];

  export const contactPersonDetails = (index) =>
    [
      'john@gmail.com , 948988499',
      'Schmidt LLC',

    ][index];


    export const Material = (index) =>
      [
        'Johns - Aufderhar',
        'Schmidt LLC',

      ][index];
      export const BankDetails = (index) =>
        [
          'Johns - Aufderhar',
          'Schmidt LLC',
          'Smitham - Gerlach',
        ...
        export const purchaseOrderNumber = (index) =>
          [
           'PO-2023001' ,
           778977
          ][index];
