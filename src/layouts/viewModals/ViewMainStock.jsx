...
export default function ViewMainStock ({ mainStockData }) {
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    label='Material Name'
                    name='materialName'
                    value={mainStockData.materialName}
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    label='Material Code'
                    name='materialCode'
                    value={mainStockData.materialCode}
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    value={mainStockData.storageLocation}
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    label='Supplier'
                    name='supplier'
                    value={mainStockData.vendorName}
