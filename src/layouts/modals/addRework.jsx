...
export default function ReworkForm({setUpdate}) {
  ...
  const validateForm = () => {
    ...
    if (!formData.proposedReworkAction) newErrors.proposedReworkAction = 'Proposed Rework Action is required';
    if (!formData.reworkStartDate) newErrors.reworkStartDate = 'Rework Start Date is required';
    if (!formData.reworkCompletionDate) newErrors.reworkCompletionDate = 'Rework Completio nDate is required';
    if (!formData.quantityForRework) newErrors.quantityForRework = 'Quantity For Rework is required';
    if (!formData.reworkStatus) newErrors.reworkStatus = 'Rework Status is required';
...
try{
    ...
    console.error('Error occured in adding Rework in client side',err.message);
}
