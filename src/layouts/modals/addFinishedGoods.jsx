...
export default function FinishedGoodsForm({setUpdate}) {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!formData.finishedGoodsName) newErrors.finishedGoodsName = 'Finished Goods Name is required';
    ...
    if (!formData.quantityProduced) newErrors.quantityProduced = 'Quantity Produced is required'
