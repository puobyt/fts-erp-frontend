...
export async function generateMaterialsReport(row) {
    ...
    doc.setFont('Times', 'bold');
    doc.text(
      'The vendors supplying the raw materials are detailed below:',
      20,
      nextY + 10
    );
...
doc.setFontSize(12);
doc.setFont('Times', 'bold');
doc.text('Details of how raw materials were utilized during the production process:', 20, productionYStart + 10);
