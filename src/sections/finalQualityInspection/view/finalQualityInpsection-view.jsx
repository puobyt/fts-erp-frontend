...
import { FinalQualityInpsectionTableHead } from '../finalQualityInpsection-table-head';
          ...
          <TableContainer sx={{ overflow: 'unset' }}>
            <Table sx={{ minWidth: 800 }}>
              <FinalQualityInpsectionTableHead
                ...
                rowCount={qualityInspections.length}
                numSelected={table.selected.length}
                onSort={table.onSort}
              ...
              <TableBody>
                ...
                <TableEmptyRows
                  height={68}
                  emptyRows={emptyRows(table.page, table.rowsPerPage, qualityInspections.length)}
                />
