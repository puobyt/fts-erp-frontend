...
export function QualityCheckTableRow({setUpdate,row, selected, onSelectRow }) {
  ...
  const handleDelete = async()=>{
      try {
        ...
        const result = await axiosInstance.delete(`/removeQualityCheck?qualityCheckId=${qualityCheckId}`);
        if (result) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <EditQualityCheckForm setUpdate={setUpdate} qualityCheckData={qualityCheckData}/>
