...
export function RequestCreationForMaterialsTableRow({setUpdate, row, selected, onSelectRow }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
        <EditRequestCreationForMaterialsForm setUpdate={setUpdate} requestMaterialsData={requestMaterialsData}/>
